  ...
  <body>
    <main class="app">
      ...
      <nav class="ribbon" aria-label="PowerPoint Ribbon">
        ...
        <div class="toolstrip" data-toolstrip aria-label="Ribbon Befehle"></div>
      </nav>
    ...
    <script>
      ...
      const toolstrip = document.querySelector('[data-toolstrip]');
      const ribbonTemplates = {
        'Datei': '<div class="group wide"><div class="group-body"><button class="ribbon-button big" data-action="copy-title"><span class="icon">💾</span><span>Speichern als Mutprobe</span></button><button class="ribbon-button" data-action="export-bullshit"><span class="icon">📄</span><span>PDF mit Haltung</span></button></div><div class="group-label">Backstage</div></div><div class="group fun"><div class="group-body"><button class="ribbon-button" data-action="share"><span class="icon">📣</span><span>An alle senden</span></button><button class="ribbon-button" data-action="compliance"><span class="icon">🧯</span><span>Compliance</span></button><button class="ribbon-button" data-action="version"><span class="icon">🕰️</span><span>Version 37_final</span></button></div><div class="group-label">Datei-Drama</div></div>',
        'Start': '<div class="group"><div class="group-body"><button class="ribbon-button big" data-action="copy-title"><span class="icon">📋</span><span>Titel kopieren</span></button></div><div class="group-label">Zwischenablage</div></div><div class="group wide"><div class="group-body"><button class="ribbon-button big" data-action="play"><span class="icon">▶</span><span>Starten</span></button><button class="ribbon-button" data-action="random"><span class="icon">🎲</span><span>Zufall</span></button><button class="ribbon-button" data-action="panic"><span class="icon">😬</span><span>Panik</span></button></div><div class="group-label">Präsentation</div></div><div class="group fun"><div class="group-body"><button class="ribbon-button" data-action="enhance"><span class="icon">💼</span><span>Executive</span></button><button class="ribbon-button" data-action="laser"><span class="icon">🔴</span><span>Laser</span></button><button class="ribbon-button" data-action="smartart"><span class="icon">🧩</span><span>SmartArt</span></button><button class="ribbon-button" data-action="chaos"><span class="icon">✨</span><span>Chaos</span></button></div><div class="group-label">Karaoke-Tools</div></div>',
        'Einfügen': '<div class="group wide"><div class="group-body"><button class="ribbon-button big" data-action="insert-chart"><span class="icon">📊</span><span>Chart ohne Daten</span></button><button class="ribbon-button" data-action="insert-quote"><span class="icon">💬</span><span>CEO-Zitat</span></button><button class="ribbon-button" data-action="insert-goose"><span class="icon">🪿</span><span>Gans</span></button></div><div class="group-label">Einfügen</div></div><div class="group fun"><div class="group-body"><button class="ribbon-button" data-action="insert-smartart"><span class="icon">🧠</span><span>SmartArt</span></button><button class="ribbon-button" data-action="insert-wordart"><span class="icon">🌈</span><span>WordArt 2003</span></button><button class="ribbon-button" data-action="insert-footer"><span class="icon">⚠️</span><span>Haftungsausschluss</span></button></div><div class="group-label">Illustrationen</div></div>',
        'Entwurf': '<div class="group wide"><div class="group-body"><div class="palette"><button style="background:#b7472a" data-theme="office" aria-label="Office Orange"></button><button style="background:#4472c4" data-theme="blue" aria-label="Berater Blau"></button><button style="background:#7030a0" data-theme="purple" aria-label="Vorstand Lila"></button><button style="background:#70ad47" data-theme="green" aria-label="Excel Grün"></button><button style="background:#111" data-theme="dark" aria-label="Krisenmodus"></button><button style="background:#ffd966" data-theme="alarm" aria-label="Gelbphase"></button><button style="background:#fff" data-theme="office" aria-label="Zurücksetzen"></button></div></div><div class="group-label">Designs</div></div><div class="group fun"><div class="group-body"><button class="ribbon-button" data-action="make-premium"><span class="icon">✨</span><span>Premium</span></button><button class="ribbon-button" data-action="align-vibes"><span class="icon">📐</span><span>Vibes ausrichten</span></button><button class="ribbon-button" data-action="brand-police"><span class="icon">🚨</span><span>Brand Police</span></button></div><div class="group-label">Varianten</div></div>',
        'Übergänge': '<div class="group fun"><div class="group-body"><button class="ribbon-button big" data-action="transition-drama"><span class="icon">🌪️</span><span>Dramatisch</span></button><button class="ribbon-button" data-action="transition-fade"><span class="icon">🌫️</span><span>Fade der Scham</span></button><button class="ribbon-button" data-action="transition-wipe"><span class="icon">🧽</span><span>Wisch & Weg</span></button></div><div class="group-label">Übergänge</div></div><div class="group wide"><div class="group-body"><button class="ribbon-button" data-action="timing-fast"><span class="icon">⏱️</span><span>Zu schnell</span></button><button class="ribbon-button" data-action="timing-awkward"><span class="icon">🫠</span><span>Peinliche Pause</span></button></div><div class="group-label">Anzeigedauer</div></div>',
        'Animationen': '<div class="group fun"><div class="group-body"><button class="ribbon-button big" data-action="chaos"><span class="icon">✨</span><span>Chaos</span></button><button class="ribbon-button" data-action="spin"><span class="icon">🌀</span><span>Drehen</span></button><button class="ribbon-button" data-action="bounce"><span class="icon">🏀</span><span>Bounce</span></button><button class="ribbon-button" data-action="laser"><span class="icon">🔴</span><span>Laser</span></button></div><div class="group-label">Animation</div></div><div class="group wide"><div class="group-body"><button class="ribbon-button" data-action="animation-pane"><span class="icon">🧾</span><span>Animationsbereich</span></button><button class="ribbon-button" data-action="too-many"><span class="icon">💥</span><span>Alle auf einmal</span></button></div><div class="group-label">Erweitert</div></div>',
        'Bildschirmpräsentation': '<div class="group wide"><div class="group-body"><button class="ribbon-button big" data-action="play"><span class="icon">▶</span><span>Von Beginn an</span></button><button class="ribbon-button" data-action="present-current"><span class="icon">⏵</span><span>Ab Auswahl</span></button><button class="ribbon-button" data-action="random"><span class="icon">🎲</span><span>Zufallsdeck</span></button></div><div class="group-label">Starten</div></div><div class="group fun"><div class="group-body"><button class="ribbon-button" data-action="coach"><span class="icon">🎤</span><span>Speaker Coach</span></button><button class="ribbon-button" data-action="heckle"><span class="icon">🍅</span><span>Publikum</span></button><button class="ribbon-button" data-action="panic"><span class="icon">😬</span><span>Notfalltext</span></button></div><div class="group-label">Probe</div></div>',
        'Ansicht': '<div class="group wide"><div class="group-body"><button class="ribbon-button big" data-action="view-editor"><span class="icon">🖥️</span><span>Normal</span></button><button class="ribbon-button" data-action="view-grid"><span class="icon">▦</span><span>Foliensortierung</span></button><button class="ribbon-button" data-action="view-notes"><span class="icon">📝</span><span>Notizen</span></button></div><div class="group-label">Ansichten</div></div><div class="group fun"><div class="group-body"><button class="ribbon-button" data-action="zoom-in"><span class="icon">🔍</span><span>Mehr Drama</span></button><button class="ribbon-button" data-action="zoom-out"><span class="icon">🔎</span><span>Weniger Mut</span></button><button class="ribbon-button" data-action="ruler"><span class="icon">📏</span><span>Lineal der Wahrheit</span></button></div><div class="group-label">Anzeigen</div></div>'
      };
      function bindRibbonActions() {
        toolstrip.querySelectorAll('[data-action]').forEach((button) => button.addEventListener('click', handleAction));
        toolstrip.querySelectorAll('[data-theme]').forEach((button) => button.addEventListener('click', handleTheme));
      }
      function setRibbon(name, { quiet = false } = {}) {
        toolstrip.innerHTML = ribbonTemplates[name] || ribbonTemplates.Start;
        bindRibbonActions();
        if (!quiet) showToast(name + '-Ribbon geladen. Inhalt: jetzt wirklich vorhanden.');
      }
      async function handleAction(event) {
        const action = event.currentTarget.dataset.action;
        if (action === 'play' || action === 'present-current') playSelected();
        ...
        if (action === 'smartart' || action === 'insert-smartart') showToast('SmartArt verweigert Dienst: zu viel Wahrheit im Deck.');
        if (action === 'chaos') { document.body.classList.toggle('karaoke-chaos'); showToast('Karaoke-Chaos kurzzeitig in den Folienmaster geschrieben.'); }
        ...
        const messages = {
          'export-bullshit':'PDF exportiert in /Gefühlte_Fakten/final_final_wirklich.pdf', 'share':'Outlook wurde geöffnet und sofort bereut.', 'compliance':'Compliance-Check: fachlich zweifelhaft, emotional belastbar.', 'version':'Wiederhergestellt: v37_final_FINAL_Logge_approved.pptx',
          'insert-chart':'Chart eingefügt: Achsen beschriftet mit „Trust me“ und „Vibes“.','insert-quote':'CEO-Zitat eingefügt: „Wir müssen da narrativ mutiger werden.“','insert-goose':'Gans eingefügt. Sie ist jetzt Stakeholder.','insert-wordart':'WordArt 2003 aktiviert. Geschmack verlässt den Raum.','insert-footer':'Fußnote eingefügt: Alle Zahlen sind dramaturgisch gerundet.',
          'make-premium':'Premiumfilter: mehr Schatten, weniger Verantwortung.','align-vibes':'Vibes wurden pixelgenau linksbündig ausgerichtet.','brand-police':'Brand Police: Orange okay, Inhalt weiterhin verdächtig.',
          'transition-drama':'Übergang gesetzt: Vorstandsdramaturgie 400ms.','transition-fade':'Fade der Scham aktiviert.','transition-wipe':'Wisch & Weg: Argumente entfernt.','timing-fast':'Timing: schneller als die Faktenprüfung.','timing-awkward':'Peinliche Pause auf 3,7 Sekunden kalibriert.',
          'spin':'Objekt dreht sich. Niemand weiß warum.','bounce':'Bounce hinzugefügt. Seriösität -12%.','animation-pane':'Animationsbereich geöffnet: 47 Effekte, 0 Gründe.','too-many':'Alle Animationen starten jetzt gleichzeitig. Gott steh uns bei.',
          'coach':'Speaker Coach: „Ähm“ erkannt, Selbstvertrauen trotzdem hoch.','heckle':'Publikum simuliert: ein skeptisches Husten hinten links.',
          'view-editor':'Normalansicht: so normal wie PowerPoint Karaoke eben wird.','view-grid':'Foliensortierung behauptet Übersicht.','view-notes':'Notizenansicht: Hier steht nur „improvisieren“.','zoom-in':'Mehr Drama gezoomt.','zoom-out':'Mut reduziert, Lesbarkeit erhöht.','ruler':'Lineal der Wahrheit eingeblendet: alles leicht schief.'
        };
      ...
      function handleTheme(event) {
        ...
        const [hot, dark] = themes[event.currentTarget.dataset.theme] || themes.office;
      ...
      document.querySelectorAll('[data-ribbon]').forEach((tab) => tab.addEventListener('click', () => { document.querySelectorAll('[data-ribbon]').forEach((t) => t.classList.remove('active')); tab.classList.add('active'); setRibbon(tab.dataset.ribbon); }));
      setRibbon('Start', { quiet: true });
